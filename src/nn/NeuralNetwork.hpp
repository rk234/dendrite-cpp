...
public:
  ...
  void add_hidden_layer(int numNeurons, ActivationFunction &fn) {
    Layer *prev;
  ...
  void set_output_layer(int numOutputs, ActivationFunction &fn) {
    Layer *prev;
  ...
  void train(Matrix trainX, Matrix trainY, int epochs, float iterations); // TODO
};
